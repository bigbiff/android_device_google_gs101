...
#TW_RECOVERY_ADDITIONAL_RELINK_BINARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/system/bin/boringssl_self_test64
TW_RECOVERY_ADDITIONAL_RELINK_VENDOR_HW_BINARY_FILES += \
					    out/target/product/$(PRODUCT_HARDWARE)/vendor/bin/hw/android.hardware.security.keymint-service.trusty
TW_RECOVERY_ADDITIONAL_RELINK_VENDOR_HW_BINARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/vendor/bin/hw/trusty_apploader
TW_RECOVERY_ADDITIONAL_RELINK_VENDOR_HW_BINARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/vendor/bin/hw/init_citadel
...
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/vendor/lib64/nos_app_identity.so
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/vendor/lib64/libtrusty_metrics.so
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/system/lib64/libtrusty.so
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/system/lib64/android.hardware.keymaster-V3-ndk_platform.so
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/system/lib64/android.hardware.identity-support-lib.so
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/system/lib64/android.hardware.identity-V3-ndk_platform.so
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/system/lib64/libdmabufheap.so
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/system/lib64/libincident.so
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += out/target/product/$(PRODUCT_HARDWARE)/system/lib64/libincidentpriv.so
...
#TW_ADDITIONAL_APEX_FILES := com.google.android.os.statsd.apex
